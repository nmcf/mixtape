...
The app opens at **http://localhost:8501**. It serves recommendations from the v3 feature set and lets you reweight features (genre, record label, ratings, country, track stats) in real time using guitar-amp-style **knobs** (0–11) in the sidebar. Two filters — **Live Albums** (Live/Both/Studio) and **Greatest Hits** (Collections/Both/Albums) — narrow results by MusicBrainz release type.
...
│   └── knob_component/                 Custom HTML/SVG rotary-knob sidebar component
├── data/
